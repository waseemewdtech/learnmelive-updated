  ...
  <section class="container" style="width: 80%;margin: auto;padding-top: 30px;">
    <div
      ...
      <section
        ...
        <div class="robotoMedium" style="font-size: 55px;padding-top: 16px;color: #3AC574;">Account Approved</div>
...
helping us maintaining a trusted workplace for all.
        ...
        <div class="robotoRegular" style="font-size: 21px;margin: auto; padding-top: 16px;max-width: 500px;text-align: center;">You can now login to use your account using the
          following link.</div>
        ...
        <div class="robotoRegular" style="padding-top: 16px;padding-bottom: 60px;"><button type="button"
            style="padding-left: 42px;padding-right: 42px;padding-top: 12px;padding-bottom: 12px;border-radius: 4px;border: 0px ;background-color: #3AC574;color: #ffffff !important;"><a
              href="{{ url('/login') }}" style="text-decoration: none;color: #ffffff;">Login</a></button></div>
      </section>
    </div>
